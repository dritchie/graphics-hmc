...
local function genExamples(gravityConstant, Connections)
	...
	Examples.linearChainNonRegularBlockStack = pfn(terra()
		...
		-- var leanAng = radians(-20.0)
		-- var lineLen = 2.0*sceneHeight
		-- var lineStart = Vec2.stackAlloc(0.5*sceneWidth, groundHeight)
		-- var lineEnd = lineStart + polar2rect(lineLen, [math.pi/2]-leanAng)
		-- for i=0,blocks.size do
		-- 	var dist = ad.math.sqrt(blocks(i):centerOfMass():distSqToLineSeg(lineStart, lineEnd))
